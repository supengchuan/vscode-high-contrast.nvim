...
function M.setup(opts)
  ...
  local colors = require("vscode-high-contrast.colors").setup(opts)
  local groups = require("vscode-high-contrast.groups").setup(colors, opts)
  ...
  vim.g.colors_name = "vscode-high-contrast-" .. opts.style
