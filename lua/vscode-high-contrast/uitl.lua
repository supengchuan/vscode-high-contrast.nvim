...
function M.brighten(color, lightness_amount, saturation_amount)
  ...
  local hsluv = require("vscode-high-contrast.hsluv")
...
---@param groups vscode-high-contrast.Highlights
...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/vscode-hc-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, vscode-high-contrast.Cache
